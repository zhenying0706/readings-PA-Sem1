...
逐篇标题、DOI、Zotero键与双语笔记见[41篇总索引](../CATALOG.md)。研究方法和证据边界见[研究方法与数据处理学习手册](../Learning_Guides/METHODS_AND_DATA_GUIDE_CN.md)，理论构念与逐篇对应见[理论与分析框架学习手册](../Learning_Guides/THEORIES_AND_ANALYTICAL_FRAMEWORKS_GUIDE_CN.md)。

For article titles, DOIs, Zotero keys, and bilingual article notes, see the [full catalog of 41 papers](../CATALOG.md). For methods and evidentiary boundaries, see the [methods and data guide](../Learning_Guides/METHODS_AND_DATA_GUIDE_CN.md). For theoretical constructs and paper-level mappings, see the [theories and analytical frameworks guide](../Learning_Guides/THEORIES_AND_ANALYTICAL_FRAMEWORKS_GUIDE_CN.md).
